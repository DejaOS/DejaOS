...
configConst.setConfig = {
    ...
    "net_type": "sysInfo.net_type", //网络类型  1以太网 0关闭网络 2wifi
    "ssid": "sysInfo.ssid",
    "psk": "sysInfo.psk",
    ...
    "nfcType": "sysInfo.nfcType",
    // 读卡扇区号
    "sectorNumber": "sysInfo.sectorNumber",
    // 读卡块号
    "blockNumber": "sysInfo.blockNumber",
    // 读卡密钥类型 1:0x60 2:0x61
    "secretkeyType": "sysInfo.secretkeyType",
    // 读卡密钥
