// UIManager.js
// "../" here is relative to dxmodules; already adjusted for this file path.
...
const UIManager = {
    ...
    init: function () {
        ...
        // Here we use MAIN layer to represent screen‑level object
        this._rootScreen = dxui.View.build(std.genRandomStr(10), dxui.Utils.LAYER.MAIN);

        // Clear default paddings / borders
