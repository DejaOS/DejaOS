...
netProService.netRes = function (data) {
    ...
    if (code == 0x01ff) {
        ...
        // let res=`vgdevicecfginforesult={sysInfo.blhorc=1,sysInfo.decoder=1,sysInfo.interval=200,sysInfo.gateway=\"192.168.60.1\",sysInfo.G1=400,sysInfo.search_timeout=80,sysInfo.ft=0,sysInfo.nfc_card_protocol=1,sysInfo.pos=\"\",sysInfo.volume1=100,sysInfo.haddr=\"http://192.168.63.12:8088/\",sysInfo.chorc=1,sysInfo.awifi_f=1,sysInfo.ascan=1,sysInfo.nfc_otag=0,sysInfo.ncr=0,sysInfo.sn_show=1,sysInfo.rotation3BgImage=\"/app/code/resource/image/background_90.png\",sysInfo.show_devname=1,sysInfo.taddr=\"192.168.1.1\",sysInfo.decoder_timeout=100,sysInfo.H1=512,sysInfo.awifi_s=1089,sysInfo.ble_mac=\"\",sysInfo.mask=\"255.255.252.0\",sysInfo.s_mode=0,sysInfo.ble_name=\"\",sysInfo.relayd=1000,sysInfo.postfix=\"\",sysInfo.ntp_interval=43200,sysInfo.blochannel=584,sysInfo.rotation2BgImage=\"/app/code/resource/image/background.png\",sysInfo.heart_data=\"www.vguang.cn\",sysInfo.version_show=1,sysInfo.safe_iv_pri=\"39fe007b83c92bd527f36019a2ddd94f5da3dd7f1780e93828e3601a1d8cb9f8\",sysInfo.I1=64,sysInfo.ntp_timeout=5,sysInfo.ndchannel=1,sysInfo.fixed_macaddr_enable=1,sysInfo.backlight=100,sysInfo.A1=0,sysInfo.p_uart1=\"115200-8-N-1\",sysInfo.p_uart2=\"115200-8-N-1\",sysInfo.wiegand_busy_delay=50,sysInfo.volume=60,sysInfo.com_passwd=\"1234567887654321\",sysInfo.dchannel=1,sysInfo.rotation1BgImage=\"/app/code/resource/image/background_90.png\",sysInfo.ocr_mode=1,`
        if (data.source == "http") {
