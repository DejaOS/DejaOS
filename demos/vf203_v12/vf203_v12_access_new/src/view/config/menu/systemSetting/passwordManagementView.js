...
passwordManagementView.init = function () {
    ...
    passwordManagementBox.align(dxui.Utils.ALIGN.TOP_MID, 0, screen.screenSize.height * (140 / 1024))
    passwordManagementBox.setSize(screen.screenSize.width * (600 / 600), screen.screenSize.height * (300 / 1024))
    ...
    passwordManagementBox.obj.lvObjSetStylePadGap(screen.screenSize.width * (0 / 600), dxui.Utils.ENUM._LV_STYLE_STATE_CMP_SAME)
    passwordManagementBox.borderWidth(screen.screenSize.width * (1 / 600))
    ...
    const ruleTitle = dxui.Label.build('ruleTitle', screenMain)
    ruleTitle.textFont(viewUtils.font(16))
    ruleTitle.align(dxui.Utils.ALIGN.CENTER, 0, screen.screenSize.height * (100 / 1024))
    ruleTitle.dataI18n = 'systemSettingView.passwordManagementRule'
    ruleTitle.textColor(0x000000)
    ...
    passwordManagementView.info.forEach(item => {
        ...
        itemLabel.width(screen.screenSize.width * (300 / 600))
        ...
        switch (item.type) {
            case 'input':
                ...
                input.setSize(screen.screenSize.width * (240 / 600), screen.screenSize.height * (55 / 1024))
                item.input = input
                break;
        }
    })
