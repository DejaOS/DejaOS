...
recordQueryView.init = function () {
    ...
    for (let i = 0; i < 3; i++) {
        ...
        codeValue.width(screen.screenSize.width * (280 / 600))
        codeValue.longMode(dxui.Utils.LABEL_LONG_MODE.SCROLL_CIRCULAR)
    ...
    const keyboardUpY = -screen.screenSize.height * (320 / 1024) // Assumes keyboard height is around 400px
