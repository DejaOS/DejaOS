...
mainView.init = function () {
    ...
    bottomSnBtn.setSize(157, 36)
    bottomSnBtn.shadow(0, 0, 0, 0, 0xffffff, 100)
    bottomSnBtn.align(dxui.Utils.ALIGN.BOTTOM_LEFT, 13, -11)
    ...
    configLbl.align(dxui.Utils.ALIGN.CENTER, 0, 30)
    ...
    pwdLbl.align(dxui.Utils.ALIGN.CENTER, 0, 30)
    ...
    appLbl.align(dxui.Utils.ALIGN.CENTER, 0, 30)
    if (config.get("base.language") == "EN") {
        appLbl.width(120)
    ...
    menu_btn.setSize(80, 80)
    viewUtils._clearStyle(menu_btn)
    menu_btn.align(dxui.Utils.ALIGN.TOP_RIGHT, -30, 250)
    ...
    setting32.source('/app/code/resource/image/setting32.png')
    ...
    miniBkgBox.hide()
    miniBkgBox.bgOpa(0)
    miniBkgBox.align(dxui.Utils.ALIGN.CENTER, 210, 0)
