...
function showFaceView() {
    ...
    if (faceview && detectionData && detectionData.length > 0) {
        faceview.show()
        faceview.setPos(detectionData[0].rect.x, detectionData[0].rect.y)
        faceview.setSize(detectionData[0].rect.w - detectionData[0].rect.x, detectionData[0].rect.h - detectionData[0].rect.y)
    } else if (faceview) {
        faceview.hide()
    }
}
